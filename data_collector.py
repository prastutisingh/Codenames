            ...
            for line in examples:
                if count <= current_count:
                    ...
                    for i, item in enumerate(clues[:5]):
                        clue_buttons.append(tk.Button(bottom_frame, text=item, fg='blue4', width=20,
                                                      font=('Helvetica', 16),
                    ...
                    for i, item in enumerate(clues[5:10]):
                        clue_buttons_2.append(tk.Button(bottom_frame, text=item, fg='blue4', width=20,
                                                        font=('Helvetica', 16),
                                                        padx=20, pady=8, command=partial(btn_click, num, item)))
                    ...
                    tk.Button(bottom_frame, text='PASS', fg='DodgerBlue3', font=('Helvetica Bold', 16), relief='raised',
                              padx=10, pady=5, command=partial(pass_click, num)).grid(row=4, column=1, columnspan=3)
